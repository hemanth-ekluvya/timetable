...
import "./CBSEClassTimetable.css";
import { format } from "date-fns";

const CBSEClassTimetable10B = () => {
  ...
  const todayClasses = [
    {
      ...
      subject: "Physics",
      teacher: "MURALI",
      topic: "Introduction to electrodynamics…..",
      time: "8:00 AM",
      start: "8:00 AM",
      end: "9:50 AM",
    },
...
export default CBSEClassTimetable10B;
