...
import "./TeacherAllottedClassesSravan.css";

const TeacherAllottedClassesSravan = () => {
            ...
            <div className="d-flex align-items-center mb-3 position-relative gap-3">
              ...
              {isOpen && (
                <div
                  ...
                  style={{ top: "70px", left: "70px", zIndex: 10 }}
                >
                  <DatePicker
...
export default TeacherAllottedClassesSravan;
