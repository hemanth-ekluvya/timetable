        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex">
            ...
            <div className="teacher-info mb-2 ms-3">
              ...
              <h4 className="mb-0">NAVEEN (Physics)</h4>
          ...
          <div className="d-flex align-items-center mb-3 position-relative gap-3">
            ...
            {isOpen && (
              <div
                ...
                style={{ top: "70px", left: "150px", zIndex: 10 }}
              >
                <DatePicker
...
export default TeacherSyallabus;
