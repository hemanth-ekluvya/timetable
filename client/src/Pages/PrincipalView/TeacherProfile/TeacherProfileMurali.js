// Shared updated template for teacher-specific profile pages
...
import "./TeacherProfileMurali.css";
...
const TeacherProfileMurali = () => {
  const { teacherName } = useParams();
  const navigate = useNavigate();

  const [selectedKey, setSelectedKey] = useState(
    teacherName || teacherKeys[0].key
  );
      ...
      <Row className="justify-content-center gap-5">
        ...
        <Col md={8}>
          ...
          <Button
            ...
            onClick={() =>
              navigate(
                `/principal/dashboard/teacher/${selectedKey}/allotted-classes`
              )
            }
          >
...
export default TeacherProfileMurali;
